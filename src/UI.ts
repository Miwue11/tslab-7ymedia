...
export const obtenerMensajeResultadoOpcional = (puntuacion: number, cartas: number[]): string => {
...
export const mostrarResultadoOpcional = (puntuacion: number, cartas: number[]): void => {
    ...
    if (resultadoOpcional instanceof HTMLDivElement && resultadoOpcional !== null) {
        resultadoOpcional.innerText = obtenerMensajeResultadoOpcional(puntuacion, cartas);
    } else {
